...
───────────────────────┐
  ...
  save [here || home]  │  сохранить и показать место хранения задач
                       │  или перенести архив:
                       │    - here: в текущую папку (по умолчанию)
                       │    - home: в папку пользователя homedir
